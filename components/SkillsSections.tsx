  ...
  const features = [
    {
      ...
      description:
        "Technológie s ktorými mám aktuálne najviac skúseností a vyhotovených projektov",
  ...
  return (
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      ...
      <div className="relative">
        <div className="grid grid-cols-1 lg:grid-cols-6 mt-12 xl:border rounded-xl dark:border-neutral-900">
...
export const SkeletonCertAndStack = () => {
  // Tech stack polia
  const leftLists = ["Tailwind", "FramerMotion", "Git"];
  const rightLists = ["NextJS", "Typescript", "Docker"];
  ...
  return (
    ...
    >
      ...
      {/* 2. Sekcia – Moje ďalšie certifikácie */}
      <div className="bg-gradient-to-br from-[#0A0E27] to-[#10132E] rounded-xl p-8 shadow-lg transition hover:shadow-xl">
        <h3 className="text-2xl font-semibold text-white mb-4 border-b border-neutral-700 pb-2">
